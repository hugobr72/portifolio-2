...
import fireBlog from '../img/FireBlog.png'
import Tilt from 'react-parallax-tilt'

type TypeFooter = {
    projetos: MutableRefObject<HTMLDivElement | undefined>
}


const Footer = ({ projetos }: TypeFooter): React.JSX.Element => {

    return (
        <footer id='projetos' ref={projetos as MutableRefObject<HTMLDivElement>}>
